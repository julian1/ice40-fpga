...
*/
    ...
    else    // cs deasserted. THIIS ONLY happens on transmit error. normally we don't have a clk to sample cs on.
      begin
  ...
  always @ (posedge cs)   // cs done.
    begin
      ...
      if(count == 16) // ie. sequence has correct number of clk cycles.
