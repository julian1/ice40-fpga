...
*/
  ...
  // OK. we assign the leds directly and it also doesn't work.

  // THIS DOESNT
  assign {  LED3, LED2, LED1, LED0 }  = { 4'b1 };       // because 4'b1 = 1 
...
// `define NUM_BITS        29    //
  ...
  reg [32-1:0] output_dummy ;

  assign {  LED3, LED2, LED1, LED0 }  = output_dummy;

  // reg [4-1:0] reg_on = { 1,1,1,1 } ; 
  ...
  mux_8to1_assign_1  (
    ...
    .b( { 32'b0   }  ),                       // mode/AF  1
    .c(  {{ 28'b0   }, 1,1,1,1   }    ),      // mode/AF  2   only sigle led is on????
    .d( { 28'b0,  reg_led[ 3: 0] }  ),        // mode/AF 3     default, follow reg_led, for led.
    .e( 32'b0  ),                       // mode/AF  4
    .f( 32'b0   ),                       // mode/AF  5
    .g( 32'b0   ),                       // mode/AF  6
    .h( 31'b1   ),                       // mode/AF  7
